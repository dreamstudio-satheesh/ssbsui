		...
		<div class="auto-container">
            ...
            <div class="mixitup-gallery">
                ...
                <div class="filter-list row clearfix">
					...
					<!-- Gallery Block Two -->
					<div class="gallery-block-two mix all industrial institutional col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="projects-detail.php"><img src="assets/images/gallery/5.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="projects-detail.php">Dassault Falcon Storage <br> Training Addition</a></h5>
							</div>
						</div>
					</div>
					...
					<div class="gallery-block-two mix all industrial col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="projects-detail.php"><img src="assets/images/gallery/6.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="projects-detail.php">Community Health Alliance <br> Sparks Health Center</a></h5>
							</div>
						</div>
					</div>
					
					<!-- Gallery Block Two -->
					<div class="gallery-block-two mix all institutional institutional col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="projects-detail.php"><img src="assets/images/gallery/7.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="projects-detail.php">Uline Site & Building <br> Shell Expansion</a></h5>
							</div>
						</div>
					</div>
					
					<!-- Gallery Block Two -->
					<div class="gallery-block-two mix all institutional col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="projects-detail.php"><img src="assets/images/gallery/8.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="projects-detail.php">Distribution Circle Commerce <br> Center</a></h5>
							</div>
						</div>
					</div>
					
					<!-- Gallery Block Two -->
					<div class="gallery-block-two mix all residential col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="projects-detail.php"><img src="assets/images/gallery/9.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="projects-detail.php">LifeChurch Phase 2A, <br> Gymnatorium</a></h5>
							</div>
						</div>
					</div>
					...
					<div class="gallery-block-two mix all institutional  col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<a href="projects-detail.php"><img src="assets/images/gallery/10.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="projects-detail.php">Hacienda Business Park <br> Distribution Facility</a></h5>
							</div>
						</div>
					</div>
				...
				<div class="button-box text-center">
					<a class="btn-style-two theme-btn" href="#"><span class="txt">View All Projects</span></a>
				</div>
