						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
								...
								<li class="dropdown"><a href="#">Services</a>
									<ul>
										<li><a href="services.php">Pre Engineered Buildings</a>
										
										<li><a href="services.php">Heavy Industrial Steel Building</a></li>
										<li><a href="services.php">Commercial PEB Building</a></li>
										<li><a href="services.php">Solar Purlins</a></li>
										<li><a href="services.php">Ventilator's</a></li>
										<li><a href="services.php">Mezzanine Floor Building </a></li>
